...
<model ref="r:fee557cd-a435-436a-b75a-82afbe25e1ad(testplugin.plugin)">
  ...
  <node concept="2DaZZR" id="6yaGLHkIBQg" />
  <node concept="sE7Ow" id="6yaGLHkIBSM">
    <property role="TrG5h" value="pastetest" />
    <property role="2uzpH1" value="testpaste" />
    ...
    <node concept="tnohg" id="6yaGLHkIBSN" role="tncku">
      <node concept="3clFbS" id="6yaGLHkIBSO" role="2VODD2">
        <node concept="3clFbF" id="uQAWgofLmB" role="3cqZAp">
          <node concept="2OqwBi" id="uQAWgofLFg" role="3clFbG">
            <node concept="10M0yZ" id="uQAWgofLn0" role="2Oq$k0">
              <ref role="3cqZAo" to="wyt6:~System.out" resolve="out" />
              <ref role="1PxDUh" to="wyt6:~System" resolve="System" />
            </node>
            <node concept="liA8E" id="uQAWgofMkj" role="2OqNvi">
              <ref role="37wK5l" to="guwi:~PrintStream.println(java.lang.String):void" resolve="println" />
              <node concept="Xl_RD" id="uQAWgofMlk" role="37wK5m">
        ...
        <node concept="3clFbF" id="2vs9_ygEfbi" role="3cqZAp">
          <node concept="2OqwBi" id="2vs9_ygEfbj" role="3clFbG">
            ...
            <node concept="liA8E" id="2vs9_ygEfbm" role="2OqNvi">
              ...
              <node concept="10Nm6u" id="uQAWgog38F" role="37wK5m" />
    ...
    <node concept="2ScWuX" id="6yaGLHkIXU2" role="tmbBb">
      <node concept="3clFbS" id="6yaGLHkIXU3" role="2VODD2">
        <node concept="3clFbF" id="6yaGLHkIYaJ" role="3cqZAp">
          <node concept="3clFbT" id="6yaGLHkIYaI" role="3clFbG">
  ...
  <node concept="tC5Ba" id="6yaGLHkIUb1">
    <property role="TrG5h" value="testgroup" />
    <node concept="ftmFs" id="6yaGLHkIUnb" role="ftER_">
      <node concept="tCFHf" id="6yaGLHkIUne" role="ftvYc">
        <ref role="tCJdB" node="6yaGLHkIBSM" resolve="pastetest" />
      </node>
    </node>
    <node concept="tT9cl" id="6yaGLHkIUng" role="2f5YQi">
